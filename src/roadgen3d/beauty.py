...
STYLE_PRESETS: Dict[str, StylePresetSpec] = {
    "civic_clean_v1": StylePresetSpec(
        ...
        scene_colors={
            ...
            "bike_lane": (50, 110, 80, 255),
            "median_green": (95, 125, 75, 255),
            "plaza": (195, 185, 165, 255),
            "garden": (140, 175, 110, 255),
            "playground": (230, 160, 90, 255),
            "amphitheater": (175, 160, 140, 255),
            "outdoor_seating": (200, 180, 155, 255),
            "parking": (155, 155, 155, 255),
        },
        surface_roughness={
            "carriageway": 0.95, "sidewalk": 0.65, "curb": 0.40,
            "context_ground": 0.85, "furnishing": 0.65, "clear_path": 0.60,
            "lane_mark": 0.30, "crossing": 0.35, "transit_pad": 0.50, "tree_pit": 0.90,
            "plaza": 0.80, "garden": 0.85, "playground": 0.75,
            "amphitheater": 0.80, "outdoor_seating": 0.78, "parking": 0.90,
        },
    ),
    "analytical_diorama_v1": StylePresetSpec(
        name="analytical_diorama_v1",
        display_name="Analytical Diorama",
        category_multipliers={
            "bench": 0.8,
            "lamp": 1.0,
            "trash": 0.65,
        ...
        category_tags={
            ...
            "lamp": ("analytical", "minimal", "metal"),
            "tree": ("formal", "canopy", "low_saturation"),
            "bollard": ("minimal", "metal"),
            "bus_stop": ("transit", "legible", "presentation"),
        },
        preferred_materials=("concrete", "stone", "metal", "wood_metal"),
        category_materials={
            "bench": ("wood_metal", "stone"),
            "lamp": ("metal",),
            "tree": ("foliage",),
        ...
        local_density_limit=3,
        scene_colors={
            "context_ground": (190, 188, 176, 255),
            "carriageway": (82, 89, 96, 255),
            "sidewalk": (201, 204, 198, 255),
            "furnishing": (181, 181, 169, 255),
            "clear_path": (220, 219, 208, 255),
            "lane_mark": (242, 238, 220, 255),
            "curb": (154, 156, 153, 255),
            "transit_pad": (141, 153, 163, 255),
            "crossing": (235, 231, 214, 255),
            "tree_pit": (116, 111, 93, 255),
            "bike_lane": (91, 129, 111, 255),
            "bus_lane": (128, 116, 104, 255),
            "parking_lane": (136, 132, 123, 255),
            "median_green": (121, 144, 103, 255),
            "grass": (126, 151, 112, 255),
            "grass_belt": (126, 151, 112, 255),
            "building_buffer": (174, 173, 158, 255),
            "shared_street_surface": (194, 193, 181, 255),
            "colored_pavement": (187, 190, 184, 255),
            "plaza": (198, 193, 181, 255),
            "garden": (136, 158, 115, 255),
            "playground": (203, 159, 104, 255),
            "amphitheater": (174, 166, 151, 255),
            "outdoor_seating": (194, 178, 155, 255),
            "parking": (151, 151, 145, 255),
        },
        surface_roughness={
            "carriageway": 0.96, "sidewalk": 0.90, "curb": 0.86,
            "context_ground": 0.92, "furnishing": 0.88, "clear_path": 0.90,
            "lane_mark": 0.76, "crossing": 0.82, "transit_pad": 0.88, "tree_pit": 0.94,
            "bike_lane": 0.92, "bus_lane": 0.93, "parking_lane": 0.92,
            "median_green": 0.95, "grass": 0.96, "grass_belt": 0.96,
            "building_buffer": 0.94, "shared_street_surface": 0.90, "colored_pavement": 0.90,
            "plaza": 0.90, "garden": 0.95, "playground": 0.88,
            "amphitheater": 0.90, "outdoor_seating": 0.88, "parking": 0.92,
        },
    ),
