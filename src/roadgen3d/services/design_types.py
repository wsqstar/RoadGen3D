...
ALLOWED_COMPOSE_CONFIG_PATCH_FIELDS: Tuple[str, ...] = (
    ...
    "street_furniture_distribution_policy",
    "program_generator",
    "layout_solver",
    "length_m",
    "road_width_m",
...
_ENUM_VALID_VALUES: Dict[str, frozenset] = {
    ...
    "furniture_balance_policy": frozenset({"overall_balanced", "side_biased_legacy"}),
    "street_furniture_distribution_policy": frozenset({"road_uniform_v1", "legacy"}),
    ...
    "building_representation": frozenset({"asset", "transparent_massing"}),
    "surrounding_building_mode": frozenset({"footprint_based", "grid_growth"}),
