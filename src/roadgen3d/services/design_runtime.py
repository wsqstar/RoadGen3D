...
def build_compose_config_from_draft(
    ...
    *,
    ...
    return StreetComposeConfig(
        ...
        median_enabled=bool(patch.get("median_enabled", DEFAULT_COMPOSE_CONFIG_PATCH_VALUES["median_enabled"])),
        median_kind=str(patch.get("median_kind", DEFAULT_COMPOSE_CONFIG_PATCH_VALUES["median_kind"])),
        median_width_m=float(patch.get("median_width_m", DEFAULT_COMPOSE_CONFIG_PATCH_VALUES["median_width_m"])),
        bus_stop_enabled=bool(patch.get("bus_stop_enabled", DEFAULT_COMPOSE_CONFIG_PATCH_VALUES["bus_stop_enabled"])),
        bus_stop_placement=str(patch.get("bus_stop_placement", DEFAULT_COMPOSE_CONFIG_PATCH_VALUES["bus_stop_placement"])),
        curb_ramp_enabled=bool(patch.get("curb_ramp_enabled", DEFAULT_COMPOSE_CONFIG_PATCH_VALUES["curb_ramp_enabled"])),
        curb_ramp_side=str(patch.get("curb_ramp_side", DEFAULT_COMPOSE_CONFIG_PATCH_VALUES["curb_ramp_side"])),
        curb_ramp_position_ratio=float(patch.get("curb_ramp_position_ratio", DEFAULT_COMPOSE_CONFIG_PATCH_VALUES["curb_ramp_position_ratio"])),
        furniture_style=str(patch.get("furniture_style", DEFAULT_COMPOSE_CONFIG_PATCH_VALUES["furniture_style"])),
