...
def build_segment_graph(
            ...
            node_specs.append(
                {
                    ...
                    "skeleton_design_profile": semantic_profile_id,
                    "skeleton_design_profile_source": "osm" if semantic_profile_id else "",
                    "skeleton_design_profile_confidence": semantic_confidence,
                    "skeleton_design_profile_reasons": semantic_reasons,
    ...
    nodes: List[RoadSegmentNode] = [
        RoadSegmentNode(
            ...
            skeleton_design_profile=str(spec["skeleton_design_profile"]),
            skeleton_design_profile_source=str(spec["skeleton_design_profile_source"]),
            skeleton_design_profile_confidence=float(spec["skeleton_design_profile_confidence"]),
            skeleton_design_profile_reasons=tuple(spec["skeleton_design_profile_reasons"]),
