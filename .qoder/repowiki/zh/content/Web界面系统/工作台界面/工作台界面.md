...
**更新** 本次更新反映了应用的重大变更：工作台界面完全重构为基于标签页的导航系统，替代原有的堆叠布局。新增五个工作流程阶段（Conversation、Scene Setup、Evidence、Design Draft、Scene Jobs），集成英雄芯片工作流程指示器，实现自动标签页切换和状态管理。
...
- [web/workbench/src/app.ts:1-1493](file://web/workbench/src/app.ts#L1-L1493)
...
- [web/workbench/src/style.css:1-761](file://web/workbench/src/style.css#L1-L761)
...
**更新** 新增了基于标签页的导航系统、英雄芯片步骤指示器、配置栏和内联3D预览功能的相关组件。
...
**图表来源**
- [web/workbench/src/app.ts:560-626](file://web/workbench/src/app.ts#L560-L626)
...
- [web/workbench/src/app.ts:1272-1296](file://web/workbench/src/app.ts#L1272-L1296)
...
- [web/workbench/src/app.ts:464-626](file://web/workbench/src/app.ts#L464-L626)
...
**更新** 新增了英雄芯片步骤指示器、配置栏、内联3D预览和标签页导航的样式定义。
...
**章节来源**
- [web/workbench/src/app.ts:670-729](file://web/workbench/src/app.ts#L670-L729)
...
**更新** 本次更新增强了用户体验，新增的基于标签页的导航系统提供了清晰的工作流程可视化，英雄芯片步骤指示器让用户能够直观地了解当前进度。配置栏简化了常用操作，内联3D预览功能提升了场景预览效率。通过增强的按钮同步逻辑，用户可以在不同界面间无缝切换操作。
...
**更新** 配置栏和标签页导航的响应式设计优化。

**章节来源**
- [web/workbench/src/style.css:686-761](file://web/workbench/src/style.css#L686-L761)
