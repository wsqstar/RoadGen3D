...
- [scripts/m2_10_ingest_assets.py](file://scripts/m2_10_ingest_assets.py)
...
- 文档位于 docs/，包含路线图、设计说明、知识库构建等背景材料。
- 数据与资源位于 data/、models/、assets/ 等目录，支撑各阶段训练与推理。

```mermaid
graph TB
subgraph "脚本层"
S_M1["scripts/m1_06_run_pipeline.py"]
S_M2["scripts/m2_10_ingest_assets.py"]
...
- [docs/readme.md:1-29](file://docs/readme.md#L1-L29)
...
- [src/roadgen3d/decoder.py:24-65](file://src/roadgen3d/decoder.py#L24-L65)
- [src/roadgen3d/decoder_shapee.py:34-245](file://src/roadgen3d/decoder_shapee.py#L34-L245)
- [scripts/m1_06_run_pipeline.py:23-107](file://scripts/m1_06_run_pipeline.py#L23-L107)
...
章节来源
- [README_M1.md:180-203](file://README_M1.md#L180-L203)
- [scripts/m2_10_ingest_assets.py:1-421](file://scripts/m2_10_ingest_assets.py#L1-L421)
...
## 附录
- 路线图与优先级参考：[docs/roadmap.md:1-175](file://docs/roadmap.md#L1-L175)
- 3D 资产与数据集说明：[docs/readme.md:1-29](file://docs/readme.md#L1-L29)