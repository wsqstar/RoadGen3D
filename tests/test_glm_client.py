...
from roadgen3d.llm.glm_client import GLMClient, GLMSettings, extract_json_payload
...
def test_glm_client_chat_json_uses_openai_compatible_shape():
    ...
    client = GLMClient(
        GLMSettings(base_url="https://example.com/v4", api_key="test-key", model="glm-test"),
